...
import vinos3.exceptions.NonexistentEntityException;
import vinos3.exceptions.PreexistingEntityException;
import vinos3.exceptions.RollbackFailureException;
...
public class CarritoJpaController implements Serializable {
    ...
    public void create(Carrito carrito) throws PreexistingEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            if (findCarrito(carrito.getIdCompra()) != null) {
    ...
    public void edit(Carrito carrito) throws NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            if (msg == null || msg.length() == 0) {
                Integer id = carrito.getIdCompra();
